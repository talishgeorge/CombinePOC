...
public protocol APIError {
    ...
    /**
    Initialize an error with some informations.
    
    - Parameters:
        - code: The error code.
        - message: The short message to display to the user.
        - description: The description of the error.
    */
    init?(code: Int, message: String?, description: String?)

    /**
    Init an Error with a json
    
    - Parameters:
        - json: A dictionary containing useful data to create an Error.
    */
...
/// Errors with [100]xxx codes
public enum GenericError: APIError {
    case undefined
    case noNetwork
